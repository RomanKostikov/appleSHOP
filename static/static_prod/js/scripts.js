...
$(document).ready(function () {
    // Логика для смены изображений при клике на миниатюры
    $('.thumbnail-item img').on('click', function () {
        const fullImageUrl = $(this).data('full');  // Получаем URL изображения
        console.log('Thumbnail clicked. New image URL: ' + fullImageUrl);  // Лог для проверки
